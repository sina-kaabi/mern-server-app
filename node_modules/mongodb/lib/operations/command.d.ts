...
export declare abstract class CommandOperation<T> extends AbstractOperation<T> {
    ...
    abstract execute(server: Server, session: ClientSession | undefined, callback: Callback<T>): void;
    executeCommand(server: Server, session: ClientSession | undefined, cmd: Document, callback: Callback): void;
}
