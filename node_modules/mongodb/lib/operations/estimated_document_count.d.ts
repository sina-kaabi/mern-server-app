...
export declare class EstimatedDocumentCountOperation extends CommandOperation<number> {
    ...
    execute(server: Server, session: ClientSession | undefined, callback: Callback<number>): void;
    executeLegacy(server: Server, session: ClientSession | undefined, callback: Callback<number>): void;
}
