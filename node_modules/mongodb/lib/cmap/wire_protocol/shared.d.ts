...
export declare function getReadPreference(cmd: Document, options?: ReadPreferenceOption): ReadPreference;
export declare function applyCommonQueryOptions(queryOptions: OpQueryOptions, options: CommandOptions): CommandOptions;
