...
declare type MechanismProperties = {
...
export declare function performGSSAPICanonicalizeHostName(host: string, mechanismProperties: MechanismProperties, callback: Callback<string>): void;
export declare function resolveCname(host: string, callback: Callback<string>): void;
export {};
